"""v3 批处理入口：默认处理 data/manifest.csv 的前 100 张图片。"""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="v3 车牌伪造筛查批处理")
    ...
    parser.add_argument("--runs-dir", default="runtime/license-v3/runs", help="每次批处理结果的根目录")
