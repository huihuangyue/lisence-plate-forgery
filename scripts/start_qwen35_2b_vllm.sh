...
model_dir="${QWEN35_MODEL_DIR:-/home/alex/models/Qwen3.5-2B}"
served_name="${QWEN35_SERVED_NAME:-qwen35-2b-local}"
listen_host="${QWEN35_HOST:-127.0.0.1}"
listen_port="${QWEN35_PORT:-8000}"
max_model_len="${QWEN35_MAX_MODEL_LEN:-16384}"
gpu_memory_utilization="${QWEN35_GPU_MEMORY_UTILIZATION:-0.82}"
...
echo "max_model_len=$max_model_len, max_num_seqs=$max_num_seqs, cpu_offload=disabled"
exec vllm "${args[@]}"
